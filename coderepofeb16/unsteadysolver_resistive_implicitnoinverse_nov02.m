...
bb=1:n1+n3+1;   %bb=ignition boundary nodes
    ...
    %proper comments to be made for why the following 'if' code is written
% if q~=0  
%    clear bb 
% end 
...
%IA=speye(size(A));
%invA = A\IA;
%invA0=invA;  %since it will be modified for ignition




%invAB0=invA0*B0;%since it will be modified for ignition

%invAB=invA*B;%since it will be modified for ignition
...
%note that the code deletes bb if there is ignition (i.e. q is not zero)
if q~=0  
   clear bb 
end 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%use vectortomatrixconvert to rearrange the Temperature and cure vectors
%into a 2D domain
